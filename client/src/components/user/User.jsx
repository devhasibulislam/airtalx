            ...
            {currentItems.map((item, index) => (
              <tr key={item.id}>
                ...
                <td className="py-2 px-4 flex gap-2">
                    ...
                    <button className="btn btn-sm btn-outline btn-error"><RiDeleteBin6Fill className="text-xl"/> </button>
                    <button className="btn btn-sm btn-outline btn-warning"><IoWarningOutline className="text-xl" /> Suspend User </button>
